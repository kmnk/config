...
nnoremap <silent>        <SID>(buffer-dir)   :<C-u>UniteWithBufferDir -buffer-name=files -prompt=buffer_dir> file file_rec buffer_tab file/new<CR>
nnoremap <silent> <expr> <SID>(buffer-file) ':<C-u>UniteWithBufferDir -buffer-name=files -prompt=buffer_dir> -input=' . expand('%:p') . ' file file_rec buffer_tab file/new<CR>'
